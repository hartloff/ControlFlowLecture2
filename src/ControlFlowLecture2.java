public class ControlFlowLecture2 {



    // 5 points
    static void Q1() {
        // print all integers from 1 to 20 (including 1 and 20)
    ...
    public static void main(String[] args) {
        ...
        // "run-as", then "Java Application". If there are no errors you will see the numbers
        // 1-20 printed below.
        Q1();
